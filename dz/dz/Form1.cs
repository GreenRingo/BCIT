...
namespace dz
{
    public partial class Form1 : Form
    {
        ...
        private void button4_Click(object sender, EventArgs e)
        {
            ...
            {
                int maxDist;
                if (!int.TryParse(this.text_box5.Text.Trim(), out maxDist))
                {
                ...
                int ThreadCount;
                if (!int.TryParse(this.text_box6.Text.Trim(), out ThreadCount))
                {
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            ...
            if (fd.ShowDialog() == DialogResult.OK)
            {
                ...
                b.AppendLine("<td>" + this.text_box2.Text + "</td>");
                b.AppendLine("</tr>");
                b.AppendLine("<tr>");
                ...
                b.AppendLine("<td>" + this.text_box1.Text + "</td>");
                b.AppendLine("</tr>");
                b.AppendLine("<tr>");
                b.AppendLine("<td>Максимальное расстояние для нечеткого поиска</td>");
                b.AppendLine("<td>" + this.text_box5.Text + "</td>");
                b.AppendLine("</tr>");
                b.AppendLine("<tr>");
                b.AppendLine("<td>Время четкого поиска</td>");
                b.AppendLine("<td>" + this.text_box4.Text + "</td>");
                b.AppendLine("</tr>");
                b.AppendLine("<tr>");
                b.AppendLine("<td>Время нечеткого поиска</td>");
                b.AppendLine("<td>" + this.text_box7.Text + "</td>");
                b.AppendLine("</tr>");
                b.AppendLine("<tr>");
                b.AppendLine("<td>Количество потоков</td>");
                b.AppendLine("<td>" + this.text_box6.Text + "</td>");
                b.AppendLine("</tr>");
                b.AppendLine("<tr valign='top'>");
                b.AppendLine("<td>Результаты поиска</td>");
                b.AppendLine("<td>");
                b.AppendLine("<ul>");
                foreach (var x in this.list_box2.Items)
                {
